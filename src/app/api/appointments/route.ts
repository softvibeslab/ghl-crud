...
// GET /api/appointments - List appointments with pagination and filters (RBAC protected)
export async function GET(request: NextRequest) {
  ...
  try {
    ...
    const result = await services.appointments.findAll(pagination, filtersWithTenant)
...
// POST /api/appointments - Create a new appointment (RBAC protected)
export async function POST(request: NextRequest) {
  // Check permission to create appointments
  const authResult = await requirePermission(request, 'appointments', 'create')
  if (authResult instanceof NextResponse) {
    return authResult
  }
  ...
  try {
    ...
    // Add tenant_id to the appointment
